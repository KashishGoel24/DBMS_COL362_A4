...
//         //    String query = "SELECT SUM(country_id) FROM country GROUP BY country_id";
//            RelNode relNode = createRelNode(query, calciteConnection);
//            List<Object []> result = eval(relNode, calciteConnection);
//             for (Object [] row : result) {
//                 for (Object col : row) {
...
//            List<Object []> result = eval(relNode, calciteConnection);
//            int x = 1;
//            System.out.println("size of the result array ");
...
//        try{
//            MyCalciteConnection calciteConnection = new MyCalciteConnection();
//         //    jupyter notebook 1 ki queries 
//             // String query = "select film_id, title from film where release_year > 2005";
...
//             // String query = "Select rental_id, rent_date, amount from (SELECT rental.rental_id as rental_id, rental.rental_date as rent_date, payment.amount as amount FROM rental left JOIN payment ON rental.rental_id  = payment.rental_id offset 14595) order by amount";
//             // String query = "select title, name from \n" + //
//             //                     "film, film_category, category \n" + //
//             //                     "where film.film_id = film_category.film_id \n" + //
//             //                     "and film_category.category_id = category.category_id and name = 'Action'";
...
//             // String query = "select distinct a1.first_name, a2.last_name \n" + //
